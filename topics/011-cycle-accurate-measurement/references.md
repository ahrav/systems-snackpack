...
- [`perf_event_open(2)`](https://man7.org/linux/man-pages/man2/perf_event_open.2.html) — perf mmap-page sequence counter, RDPMC, width, offset, and time conversion ABI.
