...
firmware, and topology before turning these contracts into operational claims.

## Linux DMA and device I/O

- [Linux Dynamic DMA Mapping Guide](https://docs.kernel.org/core-api/dma-api-howto.html)
  defines CPU, physical, and DMA address spaces; coherent and streaming
  mappings; direction; barriers; masks; map-error handling; and the original
  versus mapped scatter/gather counts.
...
- [Linux device I/O documentation](https://docs.kernel.org/driver-api/device-io.html)
  defines memory-mapped input/output (MMIO), `__iomem`, I/O accessors, and
  posted access considerations.
- [Linux I/O ordering documentation](https://docs.kernel.org/driver-api/io_ordering.html)
  explains why a device read can be required to flush posted writes before a
  critical section ends.
- [Current mainline arm64 barrier definitions](https://github.com/torvalds/linux/blob/master/arch/arm64/include/asm/barrier.h),
  [x86 barrier definitions](https://github.com/torvalds/linux/blob/master/arch/x86/include/asm/barrier.h),
  and [generic wrappers](https://github.com/torvalds/linux/blob/master/include/asm-generic/barrier.h)
  show the source-level DMA barrier lowerings discussed in the topic. These
  links track mainline and are not the measured hosts' exact kernel source.

## Translation, isolation, and bounce buffering
...
- [Linux SWIOTLB documentation](https://docs.kernel.org/core-api/swiotlb.html)
...
- [Arm System Memory Management Unit version 3 architecture](https://documentation-service.arm.com/static/69ae9767e79f9a1d642aab2d)
  specifies StreamID and SubstreamID translation context selection.
...
- [Linux `pin_user_pages` documentation](https://docs.kernel.org/core-api/pin_user_pages.html)
  defines `FOLL_PIN`, long-term pinning cases, accounting, and restrictions.
...
- [PCI-SIG ATS specification page](https://pcisig.com/PCIExpress/Specs/Base/AddressTranslationServices_1.0)
  and [PASID engineering change notice](https://pcisig.com/PCIExpress/ECN/Base/ProcessAddressSpaceID)
...
- [Linux PCI peer-to-peer DMA](https://docs.kernel.org/driver-api/pci/p2pdma.html)
  defines provider, client, orchestrator, and topology constraints for direct
...
- [Linux pagemap documentation](https://docs.kernel.org/admin-guide/mm/pagemap.html)
  ...
  physical frame number would not establish an IOVA in any case.
