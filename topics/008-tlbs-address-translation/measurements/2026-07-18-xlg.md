...
increased the complete permission-pair time. The whole-process PMU counts
differ, but setup and page-fault work prevent attributing that difference to
the timed chase. The counters do not isolate TLB capacity, interprocessor
interrupts, or one kernel invalidation path.
