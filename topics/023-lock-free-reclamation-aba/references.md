...
- WG21 P2530R3, [“Why Hazard Pointers Should be in C++26”](https://www.open-std.org/jtc1/sc22/wg21/docs/papers/2023/p2530r3.pdf), including the protect-validation protocol and two-slot traversal.
